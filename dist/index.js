    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            for (let i = 0; i < viResources.length; i++) {
                ...
                // attempting to open  
                let openAttempt = yield (0, vi_open_2.viOpen)(defaultRM.defaultRM, viResources[i], ni_visa_constants_1.NiVisaConstants.VI_NULL, 500);
